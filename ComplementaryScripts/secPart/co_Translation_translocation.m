...
reaction{2}.eq= sprintf('%s_translocate_1[c] => %s_translocate_2[c]',peptide,peptide);
reaction{3}.eq= sprintf('%s_translocate_2[c] + 2 GTP[c] + 2 H2O[c] => %s_translocate_3[c] + 2 GDP[c] + 2 phosphate[c] + H+[c]',peptide,peptide);
reaction{4}.eq= sprintf('%s_translocate_2[c] + 2 GTP[c] + 2 H2O[c] => %s_translocate_3[c] + 2 GDP[c] + 2 phosphate[c] + H+[c]',peptide,peptide);
