function [newModel,peptide_name,rxns] = addOG(model,peptide,Length_total,OG,onlyrxns)
rxns = [];
if OG >0
    Length = OG;
    
    reaction{1}.rxns = sprintf('%s_OG_EROG_sec_Pmt2p_Pmt5p_Pmt1p_Pmt6p_Pmt4p_Pmt3p_complex',peptide);
