function [newModel,peptide_name,rxns] = coat_trans_membrane(model,peptide,GPI,trans,onlyrxns)
rxns = [];
if trans >0 && GPI == 0 



    reaction{1}.rxns = sprintf('%s_COPII_TransM_ERGLA_sec_Sec12p_Sar1p_Sec23p_Sec24p_Bet1p_Bos1p_complex',peptide);
