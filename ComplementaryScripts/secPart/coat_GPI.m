...
rxns = [];
if GPI > 0
    reaction{1}.rxns = sprintf('%s_COPII_sec_GPI_ERGLB_Sec12p_Sar1p_Sec23p_Sec24p_Emp24p_complex',peptide);
    reaction{2}.rxns = sprintf('%s_COPII_sec_GPI_ERGLB_Sec13p_Sec31p_Sec16p_Sed4p_Sec5p_Sec17p_complex',peptide);
    reaction{3}.rxns = sprintf('%s_COPII_sec_GPI_ERGLB_Ypt1p_Uso1p_bug1p_Bet3p_Bet5p_Trs20p_Trs23p_Trs31p_Trs33p_complex',peptide);
