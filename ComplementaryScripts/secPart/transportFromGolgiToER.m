...
reaction{1}.rxns = sprintf('%s_GLER_COPI_formation_sec_Arf1p_Gea1p_Gea2p_Rer1p_Erd2p_Cop1p_Sec26p_Sec27p_Sec21p_Ret2p_Sec28p_Ret3p_complex',peptide);
reaction{2}.rxns = sprintf('%s_GLER_COPI_uncoating_and_fission_sec_Rer1p_Ret2p_Cop1p_Sec27p_Sec21p_Bet1p_complex',peptide);
...
reaction{2}.eq=  sprintf('%s_COPI_G1[c] => %s_mature[er]',peptide,peptide_org);
  if strcmp(compartment,'erm')== 1
    reaction{3}.rxns = sprintf('%s_GLER3_Final_demand',peptide);
